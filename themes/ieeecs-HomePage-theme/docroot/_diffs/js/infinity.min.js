...
;(function($, window) {
	...
	Plugin.prototype._shouldTriggerLoad = function() {
		var contentOffset = this.element.offset(),
			...
			//console.log('element  scrollheight: '+this.element[0].scrollHeight  );
			//console.log('element innerheight: '+this.element.innerHeight()  );
			//console.log('window height: '+this.win.height() );
			//console.log('window scrolltop: '+ this.win.scrollTop() );
			//return (!this.loading && (this.win.scrollTop() + this.element.innerHeight() + this.options.bottomBuffer) >= this.element[0].scrollHeight);
