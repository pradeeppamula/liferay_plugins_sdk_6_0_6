 ...
 * @description This class will function as the utility class for the about page
 */
package org.ieeecs.communities.util;
...
public class HomepageAboutUtil {
    static final Logger LOGGER = Logger.getLogger(HomepageAboutUtil.class);
    // meta data constants
	public static final String META_PORTLET_NAME = "homepageAbout";
