...
<c:if test="${isSignedIn}">
	...
	<div id="homepage-suggested-company-container-${id}">
		<script type="text/x-handlebars" data-template-name="companies">
			<c:if test="${canInlineEdit}">
				<span id="edit-suggested-companies-${id}" class="label label-default"><a class="inline-edit" {{action 'editSugggestedCompanies'}}><i class="icon-edit-sign"></i>&nbsp;Edit</a></span>
			</c:if>
			<div class="suggested-company-header">
				<a class="text-muted pull-right hide" href="#">View all</a>
				<p class="header">Suggested companies</p>
			</div>
			<div class="col-md-offset-2 col-sm-offset-1 row">
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company1}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title="company1.name"}}>
					<img {{bindAttr src='company1.imageURL'}} />
				</div>
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company2}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company2.name'}}>
					<img {{bindAttr src='company2.imageURL'}} />
				</div>
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company3}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company3.name'}}>
					<img {{bindAttr src='company3.imageURL'}} />
				</div>
			</div>
			<div class="col-md-offset-2 col-sm-offset-1 row">
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company4}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company4.name'}}>
					<img {{bindAttr src='company4.imageURL'}} />
				</div>
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company5}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company5.name'}}>
					<img {{bindAttr src='company5.imageURL'}} />
				</div>
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company6}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company6.name'}}>
					<img {{bindAttr src='company6.imageURL'}} />
				</div>
			</div>
			<div class="col-md-offset-2 col-sm-offset-1 row">
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company7}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company7.name'}}>
					<img {{bindAttr src='company7.imageURL'}} />
				</div>
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company8}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company8.name'}}>
					<img {{bindAttr src='company8.imageURL'}} />
				</div>
				<div class="company col-md-3 col-sm-3" {{action 'goToURL' company9}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company9.name'}}>
					<img {{bindAttr src='company9.imageURL'}} />
				</div>
			</div>
			<div class="text-right suggested-company-footer">
			 <!-- TODO: Create feedback module Phase 2/3?
                <a href="#"><i class="icon-comment icon-fixed-width"></i>Feedback</a>
                -->
			</div>

			<!-- INLINE EDIT MODAL -->
			<div class="modal fade" id="suggested-companies-edit-modal-${id}" tabindex="-1" role="dialog" aria-labelledby="suggestedCompaniesPortletAdmin" aria-hidden="true">
				<div class="modal-dialog">
				  	<div class="modal-content">
					    <div class="modal-header">
					      <button type="button" class="close" {{action 'closeSuggestedCompaniesModal'}} aria-hidden="true">&times;</button>
					    ...
					    <div class="modal-body">
					    	...
					    	<div class="suggested-companies-layout-container">
					    		<div class="col-md-offset-2 col-sm-offset-2 row">
									...
									<div id="edit-company-${id}-2" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company2}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company2.name'}}>
										<img {{bindAttr src='company2.imageURL'}} />
									</div>
									<div id="edit-company-${id}-3" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company3}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company3.name'}}>
										<img {{bindAttr src='company3.imageURL'}} />
									</div>
								</div>
								<div class="col-md-offset-2 col-sm-offset-2 row">
									<div id="edit-company-${id}-4" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company4}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company4.name'}}>
										<img {{bindAttr src='company4.imageURL'}} />
									</div>
									<div id="edit-company-${id}-5" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company5}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company5.name'}}>
										<img {{bindAttr src='company5.imageURL'}} />
									</div>
									<div id="edit-company-${id}-6" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company6}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company6.name'}}>
										<img {{bindAttr src='company6.imageURL'}} />
									</div>
								</div>
								<div class="col-md-offset-2 col-sm-offset-2 row">
									<div id="edit-company-${id}-7" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company7}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company7.name'}}>
										<img {{bindAttr src='company7.imageURL'}} />
									</div>
									<div id="edit-company-${id}-8" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company8}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company8.name'}}>
										<img {{bindAttr src='company8.imageURL'}} />
									</div>
									<div id="edit-company-${id}-9" class="company col-md-3 col-sm-3" {{action 'selectCompanyForEdit' company9}} data-toggle="tooltip" data-placement="top" {{bindAttr data-original-title='company9.name'}}>
										<img {{bindAttr src='company9.imageURL'}} />
									</div>
								</div>
					    	</div> <!-- ./suggested-companies-layout-container -->
					    	<div class="edit-company-form-container">
								<div id="changed-company-alert-${id}" class="alert alert-block alert-warning fade hide">
							    ...
							    </div> <!-- /#changed-company-alert-${id} -->
							    <div id="saved-company-alert-${id}" class="alert alert-block alert-success fade hide">
							    ...
							    </div> <!-- /#saved-company-alert-${id} -->
							    <div id="val-error-company-alert-${id}" class="alert alert-block alert-danger fade hide">
							    ...
							    </div> <!-- /#val-error-company-alert-${id} -->
								<form role="form">
								  <div class="form-group company-name-${id}">
								    <label class="control-label" for="company-name-${id}">Name</label>
								    {{view Ember.TextField valueBinding='activeEditCompany.name' classNames="form-control" placeholder="name"}}
								  </div>
								  <div class="form-group company-url-${id}">
								    <label class="control-label" for="company-url-${id}">Website URL</label>
								    {{view Ember.TextField valueBinding='activeEditCompany.url' classNames="form-control" placeholder="url"}}
								  </div>
								  <div class="form-group company-imageURL-${id}">
								    <label class="control-label" for="company-imageURL-${id}">Image URL</label>
								    {{view Ember.TextField valueBinding='activeEditCompany.imageURL' classNames="form-control" placeholder="url"}}
								    <p class="help-block">Please use the full url, i.e http://www.art.com/345.jpg</p>
								    <!-- NOTE: add back in for phase 2
								     <p class="help-block">Or, you can also simply upload an image.</p>
								    -->
								  </div>
								   <!-- NOTE: add back in for phase 2
								  <div class="form-group company-file-${id}">
								    <label class="control-label" for="company-file-${id}">File input</label>
								    <input type="file" id="company-file-${id}">
								  </div>
								  -->
								</form>
							</div> <!-- .edit-company-form-container -->
					    </div> <!-- /.modal-body -->
					    <div class="modal-footer">
					      	<button type="button" class="btn btn-default" {{action 'closeSuggestedCompaniesModal'}}>Close</button>
					      	<button type="button" {{bindAttr class=":btn :btn-primary activeEditCompany.isDirty::disabled isSaving:disabled"}} {{ action 'saveCompanies' }}>
					      		{{#if isSaving}}
								    Saving...
								{{else}}
								    Save changes
