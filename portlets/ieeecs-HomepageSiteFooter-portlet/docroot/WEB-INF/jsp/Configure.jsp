...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="homepageSiteFooterConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="homepageSiteFooterTitle"><u>Configuration for this HomepageSiteFooter Portlet</u>:</div>
	<div class="homepageSiteFooterInstanceID">Portlet Instance ID: ${id}</div>

	<div class="homepageSiteFooterMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="homepageSiteFooterConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Content Title Category</div>
		<div class="homepageSiteFooterCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Content Title to Display</div>
		<div class="homepageSiteFooterCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Portlet Border - Top <a href="/ieeecs-HomepageSiteFooter-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="homepageSiteFooterCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Portlet Border - Bottom <a href="/ieeecs-HomepageSiteFooter-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="homepageSiteFooterCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Portlet Border - Left <a href="/ieeecs-HomepageSiteFooter-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="homepageSiteFooterCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Portlet Border - Right <a href="/ieeecs-HomepageSiteFooter-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="homepageSiteFooterCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-HomepageSiteFooter-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Portlet Background Color <a href="/ieeecs-HomepageSiteFooter-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="homepageSiteFooterCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSiteFooterCellTitle">Inner Content Margins</div>
		<div class="homepageSiteFooterCell">
	...
	<div class="homepageSiteFooterRowButtons">
		<div class="homepageSiteFooterMessage" id="message${id}"></div>
...
<script src="/ieeecs-HomepageSiteFooter-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-HomepageSiteFooter-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
