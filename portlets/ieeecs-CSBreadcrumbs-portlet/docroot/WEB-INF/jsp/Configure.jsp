...
<portlet:resourceURL var='configureBreadcrumbsAjaxHandler' id='configureBreadcrumbsAjaxHandler' />

<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="csbeadcrumbsConfigure"/>
</portlet:actionURL>
...
<div class="container">
    <h4>Breadcrumbs Portlet Configuration</h2>
