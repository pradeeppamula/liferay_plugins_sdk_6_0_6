...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="communityPollConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="communityPollTitle"><u>Configuration for this Community Poll Portlet</u>:</div>
	<div class="communityPollInstanceID">Portlet Instance ID: ${id}</div>

	<div class="communityPollMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="communityPollConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Content Title Category</div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Content Title to Display</div>
		<div class="communityPollCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Portlet Border - Top <a href="/ieeecs-CommunityPoll-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="communityPollCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Portlet Border - Bottom <a href="/ieeecs-CommunityPoll-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="communityPollCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Portlet Border - Left <a href="/ieeecs-CommunityPoll-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="communityPollCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Portlet Border - Right <a href="/ieeecs-CommunityPoll-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="communityPollCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-CommunityPoll-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Portlet Background Color <a href="/ieeecs-CommunityPoll-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="communityPollCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Poll Bar Color</div>
		<div class="communityPollCell">
		
		<div class="input-prepend">
				  <span class="add-on">#</span>			
			<input class="color" type="text" id="pollBarColor${id}" name="pollBarColor${id}" value="${pollBarColor}" size="5"/>
				</div>
		</div>
		<div class="clearBoth"></div>
	</div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Show Total Number of Votes</div>
		<div class="communityPollCell">
			<select id="showVoteTotal${id}" name="showVoteTotal${id}">
				<option value="TRUE" <c:if test="${showVoteTotal == 'TRUE'}"> selected="selected" </c:if>>YES</option>
				<option value="FALSE" <c:if test="${showVoteTotal == 'FALSE'}"> selected="selected" </c:if>>NO</option>
			</select>
		</div>
		<div class="clearBoth"></div>
	</div>		
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Portlet Font Size</div>
		<div class="communityPollCell">
		<div class="input-append">
			<input type="text" id="pollFontSize${id}" name="pollFontSize${id}" value="${pollFontSize}" size="2"/> 
				  	<span class="add-on">px</span>
				</div>
		</div>
		<div class="clearBoth"></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Poll Question Size</div>
		<div class="communityPollCell">
		<div class="input-append">
			<input type="text" id="pollQuestionSize${id}" name="pollQuestionSize${id}" value="${pollQuestionSize}" size="2"/> 
				  	<span class="add-on">px</span>
				</div>
		</div>
		<div class="clearBoth"></div>
	...
	<div class="communityPollRowButtons">
		<div class="communityPollMessage" id="message${id}"></div>
...
<script src="/ieeecs-CommunityPoll-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-CommunityPoll-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	$("#configurationOptions${id}").change(function() {
		...
		$(".introSection${id},  .portletSection${id}").hide();		
		$("." + thisSelected).show();
	});	
