...
public class CSHeroContentUtil {
	...
	public static void putPortletPreferencesIntoModel(PortletPreferences prefs, Map<String,Object> model) {
		try {
            for (CustomPreferences customPref : CSHeroContentUtil.customPreferences) {
    ...
    public static boolean updatePortletData(ResourceRequest request, String modifiedByUserId) throws Exception {
        ...
        try {
            ...
            prefs.setValue("numberOfItems", ParamUtil.getString(request, "numberOfItems", CSHeroContentUtil.NUMBER_OF_ITEMS));
