 ...
 * for the featured subcontent portlet.
 */
...
public class CSFeaturedSubContentController extends BaseController implements ResourceAwareController {
    static final Logger LOGGER = Logger.getLogger(CSFeaturedSubContentController.class);
	...
	protected ModelAndView handleRenderRequestInternal(RenderRequest renderRequest, RenderResponse renderResponse) throws Exception {
		...
		try {
            ...
            CSFeaturedSubContentUtil.putPortletPreferencesIntoModel(prefs, model);
			...
			String modifiedByUserId = prefs.getValue("modifiedByUserId", CSFeaturedSubContentUtil.USERID);
			String currentMode = prefs.getValue("portletMode", CSFeaturedSubContentUtil.MODE);
            // set the group id
            groupId = Long.toString(themeDisplay.getScopeGroupId());
			if ( currentUserId.trim().equalsIgnoreCase(modifiedByUserId.trim()) && currentMode.trim().equalsIgnoreCase(CSFeaturedSubContentUtil.MODE) ) {
