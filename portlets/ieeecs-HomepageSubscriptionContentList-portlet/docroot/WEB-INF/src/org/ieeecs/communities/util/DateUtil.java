...
public class DateUtil {
    ...
    /**
     * Returns the UTC representation of a date string
     * @param date
     * @return The UTC Date object
     */
    public static Date toUTCDate(final String date) {
    	Date retVal = null;
		try {
			retVal = isoFormatter.parse(date);
