...
public class HomepageSuggestedArticleUtil {
    static final Logger LOGGER = Logger.getLogger(HomepageSuggestedArticleUtil.class);
    public static final String PROPERTY_ES_URL = "ieee.cs.elastic.search.url";
	public static final String REQUEST_TYPE_LOAD_SUGGESTED_ARTICLE_DATA = "LOAD_SUGGESTED_ARTICLE_DATA";
	...
	public static final String SUGGESTED_ARTICLE_DEFAULT_LIMIT = "3";
