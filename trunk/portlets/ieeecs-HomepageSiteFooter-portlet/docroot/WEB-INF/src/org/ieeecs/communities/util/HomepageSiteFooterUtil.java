...
public class HomepageSiteFooterUtil {
    static final Logger LOGGER = Logger.getLogger(HomepageSiteFooterUtil.class);
    // meta data constants
	public static final String META_PORTLET_NAME = "homepageSiteFooter";
