...
<portlet:resourceURL var='configureContentSideNavAjaxHandler' id='configureContentSideNavAjaxHandler' />

<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="cscontentSideNavConfigure"/>
</portlet:actionURL>
...
<div class="container">
    <h4>Content Side Navigation Portlet Configuration</h2>
