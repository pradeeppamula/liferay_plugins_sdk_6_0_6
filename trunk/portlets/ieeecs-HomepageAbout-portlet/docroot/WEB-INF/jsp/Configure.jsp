...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="homepageAboutConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="homepageAboutTitle"><u>Configuration for this HomepageAbout Portlet</u>:</div>
	<div class="homepageAboutInstanceID">Portlet Instance ID: ${id}</div>

	<div class="homepageAboutMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="homepageAboutConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Content Title Category</div>
		<div class="homepageAboutCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Content Title to Display</div>
		<div class="homepageAboutCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Portlet Border - Top <a href="/ieeecs-HomepageAbout-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="homepageAboutCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Portlet Border - Bottom <a href="/ieeecs-HomepageAbout-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="homepageAboutCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Portlet Border - Left <a href="/ieeecs-HomepageAbout-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="homepageAboutCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Portlet Border - Right <a href="/ieeecs-HomepageAbout-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="homepageAboutCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-HomepageAbout-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Portlet Background Color <a href="/ieeecs-HomepageAbout-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="homepageAboutCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageAboutCellTitle">Inner Content Margins</div>
		<div class="homepageAboutCell">
	...
	<div class="homepageAboutRowButtons">
		<div class="homepageAboutMessage" id="message${id}"></div>
...
<script src="/ieeecs-HomepageAbout-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-HomepageAbout-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
