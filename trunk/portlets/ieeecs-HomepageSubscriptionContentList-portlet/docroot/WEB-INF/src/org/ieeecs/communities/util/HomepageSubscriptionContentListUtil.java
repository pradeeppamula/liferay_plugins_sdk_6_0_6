...
public class HomepageSubscriptionContentListUtil {
    static final Logger LOGGER = Logger.getLogger(HomepageSubscriptionContentListUtil.class);

    public static final String PROPERTY_ES_URL = "ieee.cs.elastic.search.url";
	public static final String REQUEST_TYPE_USER_SUBSCRIPTION_CONTENT 	= "USER_SUBSCRIPTION_CONTENT";
