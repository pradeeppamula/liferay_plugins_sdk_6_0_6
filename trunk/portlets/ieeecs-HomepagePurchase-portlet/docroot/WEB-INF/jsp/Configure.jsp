...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="homepagePurchaseConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="homepagePurchaseTitle"><u>Configuration for this HomepagePurchase Portlet</u>:</div>
	<div class="homepagePurchaseInstanceID">Portlet Instance ID: ${id}</div>

	<div class="homepagePurchaseMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="homepagePurchaseConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Content Title Category</div>
		<div class="homepagePurchaseCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Content Title to Display</div>
		<div class="homepagePurchaseCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Portlet Border - Top <a href="/ieeecs-HomepagePurchase-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="homepagePurchaseCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Portlet Border - Bottom <a href="/ieeecs-HomepagePurchase-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="homepagePurchaseCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Portlet Border - Left <a href="/ieeecs-HomepagePurchase-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="homepagePurchaseCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Portlet Border - Right <a href="/ieeecs-HomepagePurchase-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="homepagePurchaseCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-HomepagePurchase-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Portlet Background Color <a href="/ieeecs-HomepagePurchase-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="homepagePurchaseCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepagePurchaseCellTitle">Inner Content Margins</div>
		<div class="homepagePurchaseCell">
	...
	<div class="homepagePurchaseRowButtons">
		<div class="homepagePurchaseMessage" id="message${id}"></div>
...
<script src="/ieeecs-HomepagePurchase-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-HomepagePurchase-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
