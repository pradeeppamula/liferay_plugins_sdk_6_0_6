...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="homepageArticleListConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="homepageArticleListTitle"><u>Configuration for this HomepageArticleList Portlet</u>:</div>
	<div class="homepageArticleListInstanceID">Portlet Instance ID: ${id}</div>

	<div class="homepageArticleListMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="homepageArticleListConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Content Title Category</div>
		<div class="homepageArticleListCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Content Title to Display</div>
		<div class="homepageArticleListCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Portlet Border - Top <a href="/ieeecs-HomepageArticleList-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="homepageArticleListCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Portlet Border - Bottom <a href="/ieeecs-HomepageArticleList-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="homepageArticleListCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Portlet Border - Left <a href="/ieeecs-HomepageArticleList-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="homepageArticleListCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Portlet Border - Right <a href="/ieeecs-HomepageArticleList-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="homepageArticleListCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-HomepageArticleList-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Portlet Background Color <a href="/ieeecs-HomepageArticleList-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="homepageArticleListCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageArticleListCellTitle">Inner Content Margins</div>
		<div class="homepageArticleListCell">
	...
	<div class="homepageArticleListRowButtons">
		<div class="homepageArticleListMessage" id="message${id}"></div>
...
<script src="/ieeecs-HomepageArticleList-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-HomepageArticleList-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
