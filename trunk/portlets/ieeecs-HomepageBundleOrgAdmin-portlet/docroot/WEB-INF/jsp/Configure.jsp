...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="homepageBundleOrgAdminConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="homepageBundleOrgAdminTitle"><u>Configuration for this HomepageBundleOrgAdmin Portlet</u>:</div>
	<div class="homepageBundleOrgAdminInstanceID">Portlet Instance ID: ${id}</div>

	<div class="homepageBundleOrgAdminMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="homepageBundleOrgAdminConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Content Title Category</div>
		<div class="homepageBundleOrgAdminCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Content Title to Display</div>
		<div class="homepageBundleOrgAdminCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Portlet Border - Top <a href="/ieeecs-HomepageBundleOrgAdmin-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="homepageBundleOrgAdminCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Portlet Border - Bottom <a href="/ieeecs-HomepageBundleOrgAdmin-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="homepageBundleOrgAdminCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Portlet Border - Left <a href="/ieeecs-HomepageBundleOrgAdmin-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="homepageBundleOrgAdminCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Portlet Border - Right <a href="/ieeecs-HomepageBundleOrgAdmin-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="homepageBundleOrgAdminCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-HomepageBundleOrgAdmin-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Portlet Background Color <a href="/ieeecs-HomepageBundleOrgAdmin-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="homepageBundleOrgAdminCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageBundleOrgAdminCellTitle">Inner Content Margins</div>
		<div class="homepageBundleOrgAdminCell">
	...
	<div class="homepageBundleOrgAdminRowButtons">
		<div class="homepageBundleOrgAdminMessage" id="message${id}"></div>
...
<script src="/ieeecs-HomepageBundleOrgAdmin-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-HomepageBundleOrgAdmin-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
