...
public class HomepageSuggestedCompanyUtil {
    static final Logger LOGGER = Logger.getLogger(HomepageSuggestedCompanyUtil.class);
	// meta data constants
	public static final String META_PORTLET_NAME = "homepageSuggestedCompany";

	public static final String REQUEST_TYPE_LOAD_COMPANY_DATA = "loadCompanyData";
	public static final String REQUEST_TYPE_SAVE_COMPANY_DATA = "saveCompanyData";
