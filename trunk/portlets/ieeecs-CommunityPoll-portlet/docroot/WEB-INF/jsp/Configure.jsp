...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="communityPollTitle"><u>Configuration for this Community Content Portlet</u>:</div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="communityPollCellTitle">Rest API</div>
		<div class="communityPollCell">
	...
	<div class="communityPollRowButtons">
		...
		<div class="communityPollSave"><input type="button" name="saveConfiguration${id}" id="saveConfiguration${id}" value="Save"/></div>
		<div class="clearBoth"></div>
	</div>	
