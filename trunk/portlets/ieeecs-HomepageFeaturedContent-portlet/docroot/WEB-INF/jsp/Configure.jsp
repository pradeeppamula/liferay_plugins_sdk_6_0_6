...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="homepageFeaturedContentConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="homepageFeaturedArticleTitle"><u>Configuration for this HomepageFeaturedArticle Portlet</u>:</div>
	<div class="homepageFeaturedArticleInstanceID">Portlet Instance ID: ${id}</div>

	<div class="homepageFeaturedArticleMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="homepageFeaturedArticleConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Content Title Category</div>
		<div class="homepageFeaturedArticleCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Content Title to Display</div>
		<div class="homepageFeaturedArticleCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Portlet Border - Top <a href="/ieeecs-HomepageFeaturedArticle-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="homepageFeaturedArticleCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Portlet Border - Bottom <a href="/ieeecs-HomepageFeaturedArticle-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="homepageFeaturedArticleCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Portlet Border - Left <a href="/ieeecs-HomepageFeaturedArticle-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="homepageFeaturedArticleCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Portlet Border - Right <a href="/ieeecs-HomepageFeaturedArticle-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="homepageFeaturedArticleCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-HomepageFeaturedArticle-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Portlet Background Color <a href="/ieeecs-HomepageFeaturedArticle-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="homepageFeaturedArticleCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageFeaturedArticleCellTitle">Inner Content Margins</div>
		<div class="homepageFeaturedArticleCell">
	...
	<div class="homepageFeaturedArticleRowButtons">
		<div class="homepageFeaturedArticleMessage" id="message${id}"></div>
...
<script src="/ieeecs-HomepageFeaturedArticle-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-HomepageFeaturedArticle-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
