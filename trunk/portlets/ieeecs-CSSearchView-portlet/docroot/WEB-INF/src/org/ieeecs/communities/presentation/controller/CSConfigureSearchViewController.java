...
public class CSConfigureSearchViewController extends BaseController implements ResourceAwareController {
    static final Logger LOGGER = Logger.getLogger(CSConfigureSearchViewController.class);
