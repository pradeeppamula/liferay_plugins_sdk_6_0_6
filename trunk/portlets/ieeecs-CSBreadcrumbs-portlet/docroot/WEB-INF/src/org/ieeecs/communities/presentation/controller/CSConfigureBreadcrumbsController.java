...
public class CSConfigureBreadcrumbsController extends BaseController implements ResourceAwareController {
    static final Logger LOGGER = Logger.getLogger(CSConfigureBreadcrumbsController.class);
