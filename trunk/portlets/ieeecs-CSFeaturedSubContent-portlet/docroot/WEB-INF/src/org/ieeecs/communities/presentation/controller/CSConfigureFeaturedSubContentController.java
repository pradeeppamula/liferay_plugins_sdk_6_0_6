...
public class CSConfigureFeaturedSubContentController extends BaseController implements ResourceAwareController {
    static final Logger LOGGER = Logger.getLogger(CSConfigureFeaturedSubContentController.class);
