...
<portlet:actionURL var="configureAction" portletMode="edit">
	<portlet:param name="action" value="homepageSuggestedGroupConfigure"/>	
</portlet:actionURL>
...
<form id="configureForm${id}" name="configureForm${id}" method="POST" action="${configureAction}">
	...
	<div class="homepageSuggestedGroupTitle"><u>Configuration for this SuggestedGroup Portlet</u>:</div>
	<div class="homepageSuggestedGroupInstanceID">Portlet Instance ID: ${id}</div>

	<div class="homepageSuggestedGroupMode">
	...
	<div class="customConfigIntroRow${id} introSection${id}">
		<div class="homepageSuggestedGroupConfigIntroExplanation">
			<ul>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Content Title Category</div>
		<div class="homepageSuggestedGroupCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Content Title to Display</div>
		<div class="homepageSuggestedGroupCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Portlet Border - Top <a href="/ieeecs-SuggestedGroup-portlet/templates/toolTip_PortletBorderTop.html?width=300" class="jTip" id="portletBorderTopToolTip${id}" name="What is pixel size and color of the Top Border?">(?)</a></div>
		<div class="homepageSuggestedGroupCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Portlet Border - Bottom <a href="/ieeecs-SuggestedGroup-portlet/templates/toolTip_PortletBorderBottom.html?width=300" class="jTip" id="portletBorderBottomToolTip${id}" name="What is pixel size and color of the Bottom Border?">(?)</a></div>
		<div class="homepageSuggestedGroupCell">
			<div class="input-append">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Portlet Border - Left <a href="/ieeecs-SuggestedGroup-portlet/templates/toolTip_PortletBorderLeft.html?width=300" class="jTip" id="portletBorderLeftToolTip${id}" name="What is pixel size and color of the Left Border?">(?)</a></div>
		<div class="homepageSuggestedGroupCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Portlet Border - Right <a href="/ieeecs-SuggestedGroup-portlet/templates/toolTip_PortletBorderRight.html?width=300" class="jTip" id="portletBorderRightToolTip${id}" name="What is pixel size and color of the Right Border?">(?)</a></div>
		<div class="homepageSuggestedGroupCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Portlet - Corner Radii (px) <a href="/ieeecs-SuggestedGroup-portlet/templates/toolTip_PortletCornerRadius.html?width=300" class="jTip" id="portletCornerRadiusToolTip${id}" name="What are the Corner Radii (px) for the Portlet?">(?)</a></div>
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Portlet Background Color <a href="/ieeecs-SuggestedGroup-portlet/templates/toolTip_PortletBackgroundColor.html?width=300" class="jTip" id="portletBackgroundColorToolTip${id}" name="What is Portlet background color?">(?)</a></div>
		<div class="homepageSuggestedGroupCell">
	...
	<div class="portletConfigRow${id} portletSection${id}">
		<div class="homepageSuggestedGroupCellTitle">Inner Content Margins</div>
		<div class="homepageSuggestedGroupCell">
	...
	<div class="homepageSuggestedGroupRowButtons">
		<div class="homepageSuggestedGroupMessage" id="message${id}"></div>
...
<script src="/ieeecs-SuggestedGroup-portlet/js/jtip.js" type="text/javascript"></script>
<script src="/ieeecs-SuggestedGroup-portlet/js/jscolor/jscolor.js" type="text/javascript"></script>
