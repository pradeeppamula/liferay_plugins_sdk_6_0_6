 ...
 * @description This class will handle all...
 */
package org.ieeecs.communities.util;
...
public class HomepageSuggestedGroupUtil {
    static final Logger LOGGER = Logger.getLogger(HomepageSuggestedGroupUtil.class);
	...
	public static final String SUGGESTED_GROUP_DEFAULT_LIMIT = "3";
